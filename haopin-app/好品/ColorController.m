...
-(void)createButton{
    ...
    backButton.frame = CGRectMake(10, 20, 49, 49);
    ...
    doneButton.frame = CGRectMake(kWidth-59, 20, 49, 49);
...
-(void)initUI{
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0, 69, kWidth-320, kHeight)];
