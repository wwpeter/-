...
- (void)loadView
{
   ...
   self.navigationController.navigationBar.translucent = YES;
    ...
    UIBarButtonItem *lunarItem = [[UIBarButtonItem alloc] initWithTitle:@"阴历" style:UIBarButtonItemStyleBordered target:self action:@selector(lunarItemClicked:)];
...
- (void)calendar:(FSCalendar *)calendar didSelectDate:(NSDate *)date
{
    ...
    if (self.handler) {
        self.handler([calendar stringFromDate:date format:@"M月dd"]);
    }
